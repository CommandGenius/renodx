...
float4 main(PS_IN i) : COLOR0
{
	...
	r0     = tex2D(DIFFUSEMAP_SAMPLER, i.texcoord1.xy);              // texld r0, v1, s0
	r1     = tex2D(DIFFUSEMAP_SAMPLER, i.texcoord.zw);               // texld r1, v0.zwzw, s0
	r1.xyz = r1.xyz * 0.1875;                                        // mul r1.xyz, r1, c11.y
	r2     = tex2D(DIFFUSEMAP_SAMPLER, i.texcoord.xy);               // texld r2, v0, s0
	r1.xyz = r2.xyz * 0.1875 + r1.xyz;                               // mad r1.xyz, r2, c11.y, r1
	r0.xyz = r0.xyz * 0.125 + r1.xyz;                                // mad r0.xyz, r0, c11.z, r1
	r1     = tex2D(DIFFUSEMAP_SAMPLER, i.texcoord1.zw);              // texld r1, v1.zwzw, s0
	r0.xyz = r1.xyz * 0.125 + r0.xyz;                                // mad r0.xyz, r1, c11.z, r0
	r1     = tex2D(DIFFUSEMAP_SAMPLER, i.texcoord2.xy);              // texld r1, v2, s0
	r0.xyz = r1.xyz * 0.125 + r0.xyz;                                // mad r0.xyz, r1, c11.z, r0
	r1     = tex2D(DIFFUSEMAP_SAMPLER, i.texcoord2.zw);              // texld r1, v2.zwzw, s0
	r0.xyz = r1.xyz * 0.09375 + r0.xyz;                              // mad r0.xyz, r1, c11.w, r0
	r1     = tex2D(DIFFUSEMAP_SAMPLER, i.texcoord3.xy);              // texld r1, v3, s0
	r0.xyz = r1.xyz * 0.09375 + r0.xyz;                              // mad r0.xyz, r1, c11.w, r0
	r1     = tex2D(DIFFUSEMAP_SAMPLER, i.texcoord3.zw);              // texld r1, v3.zwzw, s0
	...
	r1     = tex2D(MISCMAP3_SAMPLER, i.texcoord.xy);                 // texld r1, v0, s3
