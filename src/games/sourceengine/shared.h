#ifndef SRC_SOURCEENGINE_SHARED_H_
#define SRC_SOURCEENGINE_SHARED_H_
...
#define RENODX_SWAP_CHAIN_DECODING             (shader_injection[6][0] < 0.f ? RENODX_INTERMEDIATE_ENCODING : shader_injection[6][0])
...
#define RENODX_SWAP_CHAIN_DECODING             (shader_injection.swap_chain_decoding < 0.f ? RENODX_INTERMEDIATE_ENCODING : shader_injection.swap_chain_decoding)
...
#endif  // SRC_SOURCEENGINE_SHARED_H_
