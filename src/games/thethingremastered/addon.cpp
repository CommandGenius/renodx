...
extern "C" __declspec(dllexport) constexpr const char* DESCRIPTION = "RenoDX for The Thing: Remastered";
      ...
      if (!initialized) {
        ...
        for (const auto& [key, format] : UPGRADE_TARGETS) {
          auto* setting = new renodx::utils::settings::Setting{
              .key = "Upgrade_" + key,
              .value_type = renodx::utils::settings::SettingValueType::INTEGER,
              .default_value = (key == "R8G8B8A8_UNORM") ? UPGRADE_TYPE_OUTPUT_SIZE : UPGRADE_TYPE_NONE,
              .label = key,
